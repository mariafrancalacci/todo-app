    ...
    <div data-testid="delete-todo-modal" v-if="showDeleteModal"
      ...
      <div class=" bg-gray-500 rounded-lg p-4">
        ...
        <div class="flex justify-end mt-4">
          <button data-testid="delete-todo-cancel-button" @click="unShowModal" class="text-gray-500 mr-2">Cancel</button>
          <button data-testid="delete-todo-confirm-button" @click="handleRemoveTodo" class="text-red-500">Delete</button>
        </div>
      </div>
    </div>
